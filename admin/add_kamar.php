      ...
      <div class="panel panel-default">
        ...
        <?php
            ...
            <div class="panel-body">
              <form action="action/add_kamar_action.php" method="post" enctype="multipart/form-data">

                <div class="form-group">
                  <label for="nama" class="form-label">Nama Kamar</label>
                  <input type="text" class="form-control" id="nama" name="nama_kamar" placeholder="Contoh : Kamar#2342AB" autocomplete="off">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="rupiah1" name="harga_kamar" placeholder="Amount">
                  </div>
                </div>

                <div class="form-group">
                  <label for="deskripsi" class="form-label">Deskripsi</label>
                      <textarea class="form-control" rows="3" id="textarea1" placeholder="Blablabalba" name="deskripsi"></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_penghuni">
                        ...
                        <?php
                          $sql = mysqli_query($koneksi, "SELECT * FROM penghuni");
                          while ($a=mysqli_fetch_array($sql)) {
                              ?>
                              <option value="<?php echo $a['id_penghuni'];?>"><?php echo $a['username'];?></option>
                        <?php } ?>
                  </select>  
                </div>          
