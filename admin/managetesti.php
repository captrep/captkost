...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Data Testimonial</h1>
      <ol class="breadcrumb">
      ...
      <script>
          setTimeout(function() {
              swal({
                 ...
                 window.location.href = "managetesti.php"
              });
          }, 400);
      </script>
      <?php 
      ...
      <table class="table table-hover"> 
              ...
              <tbody>
                ...
                <tr>
                  <td><?= $row['username'];?></td>
                  <td><?= $row['isi'];?></td>
                  <td id="confirm"><a href="action/delete_testi.php?id=<?=$row['id'];?>" onclick="confirmation(event)" class="btn btn-danger btn-block"><i class="fa fa-trash-o"></i>Delete Testi</a></td>
                </tr>
                <?php endwhile ?>
              </tbody>
            </table>
