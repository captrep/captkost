...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Buat Informasi Baru</h1>
      <ol class="breadcrumb">
        ...
        <?php
            ...
            <?php
                      ...
                      <div class="kode-alert kode-alert-icon alert5">
                        <a href="" class="closed">&times;</a>
                        <i class="fa fa-warning"></i>
                         Ooops, sepertinya ada kesalahan dengan database!
                      </div>
            <?php
              }elseif($_GET['err']=="ok"){?>
                      <script>
                          setTimeout(function() {
                              swal({
                                  title: "success!",
                                  text: "Broadcast Berhasil Disebarkan!",
                                  type: "success"
                              }, function() {
            ...
            <div class="panel-body">
              <form action="action/send_broadcast.php" method="POST">
                <div class="form-group">
                  <label for="input1" class="form-label">Judul</label>
                  <input type="text" class="form-control" id="input1" name="judul" placeholder="Contoh : SALAH PARKIR" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="input2" class="form-label">Isi berita</label>
                 <textarea class="form-control" name="konten" placeholder="Contoh : Kendaraan dengan NOPOL 3434234242 Salah parkir woi!" id="foo" rows="3"></textarea>
                </div>
