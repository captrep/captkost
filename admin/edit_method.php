      ...
      <div class="panel panel-default">
        ...
        <?php
            ...
            <?php
                      ...
                      <script>
                          setTimeout(function() {
                              swal({
                                  title: "success!",
                                  text: "Method Pembayaran Berhasil diperbarui!",
                                  type: "success"
                              }, function() {
            ...
            <?php
              ...
              $id=$_GET['id_method'];
              $sql = "SELECT * FROM method WHERE id_method='$id'";
              $queryEdit=mysqli_query($koneksi,$sql);

              $row=mysqli_fetch_array($queryEdit);
              $id=$row['id_method'];
              $method=$row['nama_method'];
              $payment=$row['payment'];
            ?>
              <form action="action/save_edit_method.php" method="POST">
              <input type="hidden" name="id_method" value="<?=$id;?>">
                <div class="form-group">
                  <label for="input1" class="form-label">Nama Method</label>
                  <input type="text" class="form-control" id="input1" name="method" placeholder="Contoh : Bank Bca,Bank Bni dll" autocomplete="off" value="<?= $method;?>" autofocus>
                </div>
                <div class="form-group">
                  <label for="input2" class="form-label">Payment</label>
                  <input type="text" class="form-control" id="input2" name="payment" placeholder="Contoh : 1398729 Atas Nama Hitler" autocomplete="off" value="<?= $payment; ?>">
                </div>
                <button type="submit" class="btn btn-default btn-block">Edit Method</button>
              </form>
